...
./android.sh --disable-x86 --disable-x86-64 --disable-arm-v7a-neon --disable-arm-v7a --speed --enable-x265 --enable-gpl  --enable-android-media-codec --enable-android-zlib